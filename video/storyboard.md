# InChouf OrderPilot — promotional storyboard

Format: 16:9 website/YouTube and 9:16 social. Tone: composed, direct and optimistic. White, charcoal, violet, restrained green. No testimonials or performance statistics. All screen recordings use the explicitly labelled internal demo.

| Scene | Duration | Screen / shot | Voiceover | On-screen caption |
|---|---:|---|---|---|
| 1 | 6s | Editorial title card with a list of unanswered order details: item, quantity, address, delivery | Stop managing online orders through scattered messages and spreadsheets. | Too many details. Too many places. |
| 2 | 6s | Actual normal demo storefront and product catalog | Give your customers one place to browse, choose and order. | Your shop. Online. |
| 3 | 6s | Actual checkout, delivery details and fee | Products, options and delivery details arrive together. | A complete order, from the start. |
| 4 | 6s | Actual owner POS with the order in New | InChouf brings each order into a clear workspace. | Every order has a next step. |
...
Read only `config/contact.ts`. If a field still starts with `CONTACT_`, do not invent a replacement and do not claim the contact card is final. Render a clearly marked draft contact card or leave the final contact frame for replacement. Current website domain can appear as the intended brand domain, not a claim that this new platform is already deployed there.
