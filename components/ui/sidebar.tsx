    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className={cn(
            'mobile-sidebar-sheet w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden',
            className,
          )}
          style={
            {
        ...
        >
          ...
          <div className="mobile-sidebar-body flex h-full w-full flex-col">
            {children}
          </div>
        </SheetContent>
      </Sheet>
